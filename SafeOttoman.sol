...
contract SafeOttoman is Context, IERC20, Ownable {
    ...
    string private _name = "SafeOttoman";
    string private _symbol = "SAFEMAN";
    ...
    function swapTokensForAvax(uint256 tokenAmount) private {
        ...
        // make the swap
        pangolinRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
